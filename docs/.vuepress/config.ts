...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'hamster', // 必需
      link: 'https://github.com/witty-hamster', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:2543089266@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/witty-hamster',
        },
        // {
        //   iconClass: 'icon-erji',
        //   title: '听音乐',
    ...
    footer: {
      ...
      copyrightInfo:
        'Hamster | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
